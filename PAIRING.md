...
* **Loan/return as explicit endpoints vs generic update** — I consider these actions domain actions, not pure updatres, hence the post endpoints rather than a single put.
